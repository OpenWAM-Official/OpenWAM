...
from openwam.model.video_backbone.wan.shared.core import ModelConfig, load_state_dict
        ...
        if model_id_with_origin_paths is not None:
            ...
            for model_id_with_origin_path in model_id_with_origin_paths:
                ...
                model_configs.append(
                    ModelConfig(model_id=config.model_id, origin_file_pattern=config.origin_file_pattern, **vram_config)
                )
