...
from openwam.model.video_backbone.wan.shared.core import (
    AutoTorchModule,
    AutoWrappedLinear,
    ModelConfig,
    load_state_dict,
...
from openwam.model.video_backbone.wan.shared.core.device import IS_NPU_AVAILABLE, get_device_name
