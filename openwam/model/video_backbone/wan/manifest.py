...
``cfg.model.video_backbone.model_path`` and match against OpenWAM's Wan
...
def save_video_backbone_artifacts(output_dir: str, model_path_or_cfg) -> None:
    ...
    Args:
        ...
        model_path_or_cfg: Either a string path to the video backbone model
            directory, or a Hydra DictConfig (reads
            ``cfg.model.video_backbone.model_path``).
