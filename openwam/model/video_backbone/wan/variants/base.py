...
class WanVariant:
    ...
    ``WanBackboneBase.preprocess_input_for_train`` merges them into the shared
    ...
    # ``WanBackboneBase.needs_first_frame_skip``.
    ...
    def build_train_conditioning(
        ...
        **kw,
        ...
        ``bb`` is the :class:`WanBackboneBase`; variants call its component
