...
class WanVariant:
    ...
    ``WanVideoBackbone.preprocess_input_for_train`` merges them into the shared
    ...
    # ``WanVideoBackbone.needs_first_frame_skip``.
    ...
    def build_train_conditioning(
        ...
        **kw,
        ...
        ``bb`` is the :class:`WanVideoBackbone`; variants call its component
