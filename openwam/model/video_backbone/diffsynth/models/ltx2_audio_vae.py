...
from .ltx2_common import AudioLatentShape, NormType, Patchifier, VideoLatentShape, build_normalization_layer
...
class AudioPatchifier(Patchifier):
    ...
    def unpatchify_audio(self, audio_latents: torch.Tensor, channels: int, mel_bins: int) -> torch.Tensor:
        audio_latents = einops.rearrange(
            audio_latents,
            "b t (c f) -> b c t f",
            c=channels,
