import torch
from transformers import Siglip2ImageProcessorFast, Siglip2VisionConfig, Siglip2VisionModel, SiglipImageProcessor
from transformers.models.siglip.modeling_siglip import SiglipVisionConfig, SiglipVisionTransformer

from openwam.model.video_backbone.diffsynth.core.device.npu_compatible_device import get_device_type
