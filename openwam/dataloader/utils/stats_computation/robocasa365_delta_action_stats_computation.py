"""Normalization statistics for compact RoboCasa365DeltaAction state19/action15 v3 data."""
...
from openwam.dataloader.robocasa365_delta_action import (
    ACTION_DIM,
    ACTION_STATS_KEY,
    STATE_DIM,
    STATE_STATS_KEY,
...
from scripts.convert_robocasa365_delta_action_v3 import (
    StatsAccumulator,
    _stats_payload,
)
...
def main() -> int:
    ...
    parser.add_argument("data_root", nargs="+", help="one or more compact RoboCasa365DeltaAction v3 repositories")
    ...
    if len(args.data_root) == 1:
        output = args.output or os.path.join(args.data_root[0], f"{args.task or 'robocasa365_delta_action'}_compact_stats.npy")
