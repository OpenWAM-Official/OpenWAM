...
The executor overlaps generation of the next action chunk with execution of the
current executable horizon. This is a runtime scheduling optimization only; it
does not change the model API or the denoising algorithm.
"""
