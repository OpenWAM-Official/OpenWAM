...
def add_dataset_base_config(parser: argparse.ArgumentParser):
    parser.add_argument("--dataset_base_path", type=str, default="", help="Base path of the dataset (required for unified dataset type).")
...
def add_training_config(parser: argparse.ArgumentParser):
    ...
    parser.add_argument("--max_steps", type=int, default=None, help="Max training steps. Overrides --num_epochs when set.")
...
def add_output_config(parser: argparse.ArgumentParser):
    ...
    parser.add_argument("--rolling_save_steps", type=int, default=None, help="High-frequency rolling checkpoint interval. Only the last K are kept (see --keep_last_k_ckpts).")
    parser.add_argument("--keep_last_k_ckpts", type=int, default=2, help="Number of rolling checkpoints to keep. Default 2.")
    return parser
