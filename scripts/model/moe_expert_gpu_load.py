"""GPU-based end-to-end MoE Expert architecture test.

Loads video backbone + MoE Expert from YAML configs, runs joint forward pass
through model_fn (video DiT with action tokens in-sequence + expert FFN),
...
def main():
    ...
    print(f"  expert_layers:   {bridge_layers}")
    print("=" * 60)
    ...
    arch.moe_dit.to(dtype=torch.bfloat16, device=args.device)
    ...
    print("\n" + "=" * 60)
    print("MoE Expert end-to-end test passed.")
