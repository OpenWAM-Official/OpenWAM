...
Usage:
    python scripts/model/dual_system_gpu_load.py
    python scripts/model/dual_system_gpu_load.py --model_path /path/to/model
    python scripts/model/dual_system_gpu_load.py --bridge_type joint_self_attn
...
def main():
    ...
    parser.add_argument("--bridge_type", type=str, default=None, help="Test specific bridge_type. Default: test all.")
    ...
    print("=" * 60)
    print("DualSystem End-to-End GPU Test")
    ...
    # --- Collect bridge features ---
    print("\n[3/5] Running video DiT + bridge feature collection...")
