"""OpenWAM evaluation adapter for RoboCasa365 native-delta state19/action15.
...
STATE_DIM = 19
REPRESENTATION = "robocasa365_delta_action"
...
class OpenWAMRoboCasa365DeltaActionPolicy:
    ...
    def __init__(
        ...
        debug: bool = False,
        debug_dir: str = "./debug_robocasa365_delta_action",
        _client=None,
    ) -> None:
        ...
        print(
            f"[OpenWAMRoboCasa365DeltaActionPolicy] state_dim={self._state_dim} "
