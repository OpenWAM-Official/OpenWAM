...
``ROBOCASA365_DELTA_ACTION_PYTHON``. ``roundtrip`` only needs
...
def env_smoke(task: str, split: str, steps: int) -> None:
    ...
    from openwam2robocasa365_delta_action_interface import ACTION_SLICES  # noqa: PLC0415
...
def main(argv=None) -> int:
    ...
    parser.add_argument("--task", default=os.environ.get("ROBOCASA365_DELTA_ACTION_SMOKE_TASK", "OpenDrawer"))
    parser.add_argument("--split", default=os.environ.get("ROBOCASA365_DELTA_ACTION_SMOKE_SPLIT", "target"))
    parser.add_argument(
        "--steps", type=int, default=int(os.environ.get("ROBOCASA365_DELTA_ACTION_SMOKE_STEPS", "1"))
    )
    parser.add_argument("--host", default=os.environ.get("ROBOCASA365_DELTA_ACTION_POLICY_HOST", "127.0.0.1"))
    parser.add_argument("--port", type=int, default=int(os.environ.get("ROBOCASA365_DELTA_ACTION_PORT", "8848")))
