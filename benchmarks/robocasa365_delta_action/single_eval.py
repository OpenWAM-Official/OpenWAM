...
from openwam2robocasa365_delta_action_interface import (  # noqa: E402
    DEFAULT_HEAD_CAMERA_KEY,
    DEFAULT_LEFT_WRIST_CAMERA_KEY,
    DEFAULT_RIGHT_CAMERA_KEY,
    DEFAULT_STATE_KEYS,
    OpenWAMRoboCasa365DeltaActionPolicy,
)
...
def _build_policy(cfg: dict) -> OpenWAMRoboCasa365DeltaActionPolicy:
    return OpenWAMRoboCasa365DeltaActionPolicy(
        ...
        debug_dir=cfg.get("debug_dir", "./debug_robocasa365_delta_action"),
    )
