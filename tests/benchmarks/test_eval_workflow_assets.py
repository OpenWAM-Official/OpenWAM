...
WORKFLOW_FILES = {
    "libero": ('environment.yml', 'setup_env.sh', 'run_smoke.sh', 'smoke_libero.py', 'policy_config.yml', 'openwam2libero_interface.py', 'single_eval.sh', 'single_eval.py', 'run_eval.sh', 'run_all_suites.py', 'scheduler.py', 'patches/libero-pytorch-load.patch'),
    "robocasa365": (
        "environment.yml",
        "setup_env.sh",
        "run_smoke.sh",
...
@pytest.mark.parametrize(
    "relative_path",
    ['benchmarks/libero/setup_env.sh', 'benchmarks/libero/run_smoke.sh', 'benchmarks/libero/run_eval.sh', 'benchmarks/robocasa365/setup_env.sh', 'benchmarks/robocasa365/run_smoke.sh', 'benchmarks/robocasa365/run_eval.sh'],
)
...
@pytest.mark.parametrize(
    ...
    [('benchmarks/libero/environment.yml', 'libero'), ('benchmarks/robocasa365/environment.yml', 'robocasa365')],
)
