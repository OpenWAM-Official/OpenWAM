...
def test_delta_action_and_achieved_state_statistics_are_not_pooled():
    ...
    np.testing.assert_allclose(payload["robocasa365_delta_action"]["min"][:3], [-1, -0.5, 0])
    np.testing.assert_allclose(payload["robocasa365_delta_action_state"]["min"][:3], [10, 20, 30])
    np.testing.assert_allclose(payload["robocasa365_delta_action"]["min"][3:9], -1)
    np.testing.assert_allclose(payload["robocasa365_delta_action_state"]["min"][3:9], -1)
